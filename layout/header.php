        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="index.php?act=loai" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Tên Loại</a>
                    <a href="index.php?act=sanpham" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Sản Phẩm </a>
